...
SDPInfo.parse = function (string) {
    ...
    for (let i in sdp.media) {
        ...
        for (let j = 0; md.candidates && j < md.candidates.length; ++j) {
            ...
            const candidateInfo = new CandidateInfo(candidate.foundation, candidate.component, candidate.transport, candidate.priority, candidate.ip, candidate.port, candidate.type, candidate.raddr, candidate.rport);
            //Add it
            sdpInfo.addCandidate(candidateInfo);
        }
...
//# sourceMappingURL=SDPInfo.js.map