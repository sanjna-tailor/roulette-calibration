...
class CandidateInfo {
    ...
    plain() {
        ...
        if (this.relAddr)
            plain.relAddr = this.relAddr;
        if (this.relPort)
            plain.relPort = this.relPort;
        //Return plain object
        return plain;
    }
    /**
...
CandidateInfo.expand = function (plain) {
    ...
    //Create new
    return new CandidateInfo(plain.foundation, plain.componentId, plain.transport, plain.priority, plain.address, plain.port, plain.type, plain.relAddr, plain.relPort);
};
/**
