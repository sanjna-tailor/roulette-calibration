...
CodecInfo.expand = function (plain) {
    ...
    //Create new
    const codecInfo = new CodecInfo(plain.codec, plain.type, plain.params);
    //If they have rtx
    if (plain.rtx)
        //Set it
...
CodecInfo.MapFromNames = function (names, rtx, rtcpfbs) {
    ...
    for (const element of names) {
        ...
        for (const element of params) {
            ...
            //Add it
            codec.addParam(param[0].trim(), (_a = param[1]) === null || _a === void 0 ? void 0 : _a.trim());
        }
        //Append
        codecs.set(pt, codec);
    }
...
//# sourceMappingURL=CodecInfo.js.map