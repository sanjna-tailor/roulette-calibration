...
import { Matrix2d } from '../proj2d/Matrix2d.mjs';
import { AFFINE } from '../base/LinearProjection.mjs';
...
const _Matrix3d = class {
  ...
  applyInverse(pos, newPos) {
    ...
    if (!this.cacheInverse || this._updateId !== this._dirtyId) {
      ...
      _Matrix3d.glMatrixMat4Invert(mat4, a);
    }
    const w1 = 1 / (mat4[3] * x + mat4[7] * y + mat4[11] * z + mat4[15]);
    ...
    z += 1;
    const w2 = 1 / (mat4[3] * x + mat4[7] * y + mat4[11] * z + mat4[15]);
    ...
    newPos.set((x2 - x1) * alpha + x1, (y2 - y1) * alpha + y1, 0);
    return newPos;
  }
  invert() {
    _Matrix3d.glMatrixMat4Invert(this.mat4, this.mat4);
    return this;
  }
  invertCopyTo(matrix) {
    if (!this._mat4inv) {
  ...
  clone() {
    return new _Matrix3d(this.mat4);
  }
  copyTo3d(matrix) {
    const mat3 = this.mat4;
  ...
  setToMult(pt, lt) {
    _Matrix3d.glMatrixMat4Multiply(this.mat4, pt.mat4, lt.mat4);
    this._dirtyId++;
    return this;
  }
 ...
 * @const
 */
Matrix3d.IDENTITY = new _Matrix3d();
/**
 * A temp matrix
 *
 * @static
 * @const
 */
Matrix3d.TEMP_MATRIX = new _Matrix3d();

export { Matrix3d };
//# sourceMappingURL=Matrix3d.mjs.map
