import { ExtensionType, Geometry, Buffer, BatchShaderGenerator, Color } from '@pixi/core';
import { TYPES } from '../external/@pixi/constants/lib/index.mjs';
import { Matrix } from '@pixi/math';
import '../base/index.mjs';
import { UniformBatchRenderer } from '../base/webgl/UniformBatchRenderer.mjs';
...
class BatchBilinearGeometry extends Geometry {
  constructor(_static = false) {
    super();
    this._buffer = new Buffer(null, _static, false);
    this._indexBuffer = new Buffer(null, _static, true);
    this.addAttribute("aVertexPosition", this._buffer, 2, false, TYPES.FLOAT).addAttribute("aTrans1", this._buffer, 3, false, TYPES.FLOAT).addAttribute("aTrans2", this._buffer, 3, false, TYPES.FLOAT).addAttribute("aSamplerSize", this._buffer, 2, false, TYPES.FLOAT).addAttribute("aFrame", this._buffer, 4, false, TYPES.FLOAT).addAttribute("aColor", this._buffer, 4, true, TYPES.UNSIGNED_BYTE).addAttribute("aTextureId", this._buffer, 1, true, TYPES.FLOAT).addIndex(this._indexBuffer);
  }
}
class BatchBilinearRenderer extends UniformBatchRenderer {
...
export { BatchBilinearGeometry, BatchBilinearRenderer };
//# sourceMappingURL=SpriteBilinearRenderer.mjs.map
