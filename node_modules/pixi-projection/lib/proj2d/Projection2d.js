...
class Projection2d extends LinearProjection.LinearProjection {
  constructor(legacy, enable) {
    ...
    this.local = new Matrix2d.Matrix2d();
    this.world = new Matrix2d.Matrix2d();
  }
  onChange() {
  ...
  mapQuad(rect, p) {
    ...
    let k2 = 2;
    let k3 = 3;
    const f = utils.getIntersectionFactor(p[0], p[2], p[1], p[3], t0);
    if (f !== 0) {
      k1 = 1;
      k2 = 3;
      k3 = 2;
...
//# sourceMappingURL=Projection2d.js.map
